          ...
          <Stack spacing={3}>
            ...
            >
              ...
              <Typography variant="body1" color="text.secondary">
                Revisa aquí tus confirmaciones, tus solicitudes recientes y las
                asignaciones públicas visibles sin recargar el flujo de
                solicitud.
              </Typography>
            </Box>
              ...
              <CardContent>
                <Stack spacing={2.5}>
                  ...
                  {state.publicAssignments.length > 0 ? (
                          ...
                          <CardContent>
                            <Stack spacing={1}>
                              ...
                              <Chip
                                ...
                                color={
                                  state.config.showParticipantsPublicly
                                    ? "primary"
                                    : "default"
                                }
                              />
                    ...
                    <Alert severity="info">
                      Todavia no hay asignaciones publicas visibles.
                    </Alert>
                  )}
                </Stack>
              </CardContent>
